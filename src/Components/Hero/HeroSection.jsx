...
function HeroSection() {
  return (
    <section className="bg-gray-900 pt-10 md:pt-8">
      ...
      <div className="" />
      {/* Outlet section */}
      <div className="pt-10 md:pt-16 lg:pt-10 px-4 md:px-8 lg:px-16 flex flex-col justify-center text-center">
        <h1 className="mb-2 md:mb-4 lg:mb-6 md:px-24 text-5xl md:text-6xl font-extrabold tracking-tight leading-none md:text-center text-white">
        ...
        <button
          type="submit"
          className="my-8 md:my-16 mx-auto px-14 py-4 border-2 border-gray-300 border-dashed text-white bg-transparent font-medium rounded-lg text-lg md:text-xl "
        >
          Under Process
        </button>
